package kr.hhplus.be.server.reservation.common;
...
@Transactional
@ActiveProfiles("test")
@SpringBootTest(classes = {ServerApplication.class, TestConfiguration.class})
public abstract class ReservationIntegrationTestBase {
     ...
     * =============================================
     */
    protected MakeReservationResult reserveSeat(UUID userId, UUID seatId) {
        MakeReservationCommand cmd = new MakeReservationCommand(userId, seatId);
